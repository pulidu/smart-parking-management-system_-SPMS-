 ...
 * the JSON produced by the API Gateway, User Service and Vehicle Service error
 * handlers so clients see a consistent error contract across the whole system.
 */
