package com.smartparkingmanagementsystem.payment.config;
...
/**
 * Provides the load-balanced {@link RestClient} used by the payment service to
 ...
 * a payment request indefinitely.
 */
@Configuration
public class RestClientConfig {
    ...
    RestClient loadBalancedRestClient(
            ...
            @Value("${payment-service.client.connect-timeout-ms:3000}") long connectTimeoutMs,
            @Value("${payment-service.client.read-timeout-ms:5000}") long readTimeoutMs) {
