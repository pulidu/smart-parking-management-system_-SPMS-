...
/**
 * Translates exceptions raised by the payment-service into consistent JSON error
 * responses.
 *
 * <ul>
 *   <li>payment / reservation not found                -&gt; 404</li>
 *   <li>duplicate payment for the same reservation     -&gt; 409</li>
 *   <li>invalid payment data (card format / Luhn)      -&gt; 400</li>
 *   <li>parking service unreachable                    -&gt; 503</li>
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleInvalidPaymentData(InvalidPaymentDataException ex,
                                                             HttpServletRequest request) {
        return build(HttpStatus.BAD_REQUEST, ex.getMessage(), request, null);
    }

    @ExceptionHandler(PaymentServiceUnavailableException.class)
    public ResponseEntity<ApiError> handlePaymentUnavailable(PaymentServiceUnavailableException ex,
                                                             HttpServletRequest request) {
